function Deny-VpcPeering
{
    ...
    PROCESS
    {
        ...
        $_pcx_list | ForEach-Object {
            ...
            if ($PSCmdlet.ShouldProcess($_format_pcx, "Reject VPC Peering request"))
            {
                # Call the API to reject the peering.
                try {
                    Deny-EC2VpcPeeringConnection -Verbose:$false $_.VpcPeeringConnectionId | Out-Null
