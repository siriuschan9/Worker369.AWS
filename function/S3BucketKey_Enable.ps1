function Enable-S3BucketKey
{
    ...
    PROCESS
    {
        ...
        $_bucket_list | ForEach-Object {
            ...
            if ($PSCmdlet.ShouldProcess($_.BucketArn, 'Enable S3 Bucket Key'))
            {
                try {
                    ...
                    # Enable bucket key on the encryption rule.
                    $_encryption_rule.BucketKeyEnabled = $true
